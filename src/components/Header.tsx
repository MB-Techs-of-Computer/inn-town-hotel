...
export default function Header() {
  ...
  const isMenuItemActive = (item: any) => {
    ...
    if (item.submenu?.some((sub: any) => sub.href === pathname)) return true;
    return false;
  };
          ...
          <div className="container container-custom-three">
            <div className="d-md-flex align-items-center justify-content-between">
              ...
              <div className="header-social-links">
                <a href="https://www.facebook.com/inntownhotel/" target='_blank' rel="noopener noreferrer" aria-label="Facebook">
                  <i className="fab fa-facebook-f"></i>
                </a>
                <a href="https://www.instagram.com/inntownhotel/" target='_blank' rel="noopener noreferrer" aria-label="Instagram">
                          ...
                          <ul className="submenu">
                            {item.submenu.map((sub: any, subIndex: number) => (
                              <li key={subIndex}>
                                <Link
                                  href={sub.href}
                                  className={pathname === sub.href ? 'active-submenu' : ''}
                                >
                                  {sub.label}
                                </Link>
                              </li>
